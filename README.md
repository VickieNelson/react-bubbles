...
A token is used for authentication when a user inputs the correct predetermined credentials

- [ ] What steps can you take in your web apps to keep your data secure?

you can allow users to sign in and have a token that allows them to view certain pages (ie protected)

- [ ] Describe how web servers work.

They send out web page information when the user requests it
